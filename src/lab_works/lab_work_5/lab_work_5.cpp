...
namespace M3D_ISICG
{
	...
	bool LabWork5::init()
	{
		...
		_bunny.load( "sponza", "Data/sponza/sponza.obj" );
	...
	void LabWork5::render()
	{
		...
		_bunny.render( _program );
		 ...
		 glProgramUniform3f( _program, glGetUniformLocation( _program, " ambient" ), 1.0, 0.0, 0.0 ); 
	...
	void LabWork5::_initCamera()
	{
		...
		_camera.setPosition( Vec3f( 0.f, 0.f, 1.5f ) );
